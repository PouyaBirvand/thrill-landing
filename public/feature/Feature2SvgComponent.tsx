    ...
    <g clipPath="url(#clip0_2055_279)">
      ...
      <g mask="url(#mask0_2055_279)">
        ...
        <motion.g
          ...
          transition={{ duration: 10, ease: "linear", repeat: Infinity, repeatType: "loop", times: [0, 0.5, 1] }}
        >
          <path
            fill="#fff"
            fillOpacity="0.01"
        ...
        <motion.g
          ...
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: -50, opacity: [0, 1, 0] }}
          transition={{ duration: 10, ease: "linear", repeat: Infinity, repeatType: "loop", times: [0, 0.5, 1], delay: 0.5 }}
        >
          <path
            fill="#fff"
            fillOpacity="0.01"
        ...
        <motion.g
          ...
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: -50, opacity: [0, 1, 0] }}
          transition={{ duration: 10, ease: "linear", repeat: Infinity, repeatType: "loop", times: [0, 0.5, 1], delay: 1 }}
        >
          <path
            fill="#fff"
            fillOpacity="0.01"
        ...
        <motion.g
          ...
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: -50, opacity: [0, 1, 0] }}
          transition={{ duration: 10, ease: "linear", repeat: Infinity, repeatType: "loop", times: [0, 0.5, 1], delay: 1.5 }}
        >
          <path
            fill="#fff"
            fillOpacity="0.01"
