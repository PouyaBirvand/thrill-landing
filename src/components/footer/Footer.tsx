                        ...
                        >
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-white/70">
                                    <li><a href="#" className="transition-colors hover:text-accent-green_light">Casino</a></li>
                                    <li><a href="#" className="transition-colors hover:text-accent-green_light">Sports</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-white/70">
                                    <li><a href="#" className="transition-colors hover:text-accent-green_light">E-mail us</a></li>
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-3 text-center md:text-left">
                            <div className="text-[#A0ACC7] flex flex-row items-center gap-3">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <a href="#" className="underline transition-colors hover:text-accent-green_light">Terms</a>
                                    <a href="#" className="underline transition-colors hover:text-accent-green_light">Privacy</a>
                                </div>
                            </div>
                        </div>
