  ...
  ({ className, variant, size, rightIcon, ...props }, ref) => {
    ...
    return (
      <div className="relative w-full h-12 sm:h-14">
        ...
        {/* Secondary gradient with blur effect */}
        <div
          className={`absolute inset-0 rounded-full transition-opacity duration-500 ease-in-out ${
            isFocused ? "opacity-100" : "opacity-0"
          }`}
        ...
        <div
          className={`absolute inset-0 rounded-full border transition-opacity duration-500 ease-in-out ${
        ...
        <div className="relative flex items-center h-full px-4 sm:px-6 rounded-full z-20 bg-[#F8F8F805]">
          <div
            className={`absolute w-full right-0 bg-transparent h-8 sm:h-10 top-0 -translate-y-1/2 backdrop-blur-sm transition-opacity duration-500 ease-in-out ${
              isFocused ? "opacity-100" : "opacity-0"
            }`}
            style={{
